import { Code, Database, Globe, Sparkles, Terminal } from 'lucide-react';
...
const games = [
  ...
  },
  {
    id: 'cpp',
    title: "C++ Adventure",
    description: "Master C++ concepts with hands-on programming challenges and quizzes.",
    icon: Terminal,
    level: "Intermediate",
    players: 800,
  ...
  },
  {
    id: 'c',
    title: "C Programming",
    description: "Learn fundamental C programming concepts through interactive exercises.",
    icon: Terminal,
    level: "Intermediate",
    players: 750,
